...
export default function Bookings() {
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      setLeads(leadRes.data.filter((l) => !['Closing', 'Dead', 'Booking'].includes(l.status)));
    } catch {
            ...
            <div style={styles.formGrid}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, nama_calon: e.target.value })}
                  required
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, nominal_booking: e.target.value })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, tgl_expired: e.target.value })}
                  required
                  style={styles.input}
                />
                ...
                return (
                  <tr key={b.id} style={styles.tr}>
                    <td style={styles.td}>
                      ...
                      {b.catatan && <div style={styles.subText}>{b.catatan}</div>}
                    </td>
          ...
          <div style={styles.modal}>
            ...
            <div style={styles.convertInfo}>
              ...
              {showConvert.nominal_booking > 0 && (
                ...
                >
                  ✓ Booking fee {formatRp(showConvert.nominal_booking)} akan dihitung sebagai
                  pembayaran
                </div>
              )}
            </div>
            ...
            <div style={styles.formGrid}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setConvertForm({ ...convertForm, terbayar: e.target.value })}
              ...
              <div>
                ...
                <select
                  ...
                  style={styles.input}
                >
                  {['KPR', 'Cash Keras', 'Cash Bertahap', 'Lainnya'].map((m) => (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setConvertForm({ ...convertForm, tgl_akad: e.target.value })}
                  style={styles.input}
                />
              </div>
            </div>
