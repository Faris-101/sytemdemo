...
const mockState = {
  units: [
    {
      ...
      harga: 1850000000,
      status: "Terjual",
      fasilitas: "Smart Home, Private Pool, 4 Kamar Tidur",
      catatan: "Unit sudut premium, hadap taman utama",
    ...
    },
    {
      ...
      status: "Terjual",
      fasilitas: "Smart Home, Private Pool, 4 Kamar Tidur",
      catatan: "Hadap Timur, pencahayaan alami maksimal",
    ...
    },
    {
      ...
      harga: 1650000000,
      status: "Dipesan",
      fasilitas: "Smart Home, 3 Kamar Tidur, Garden",
      catatan: "Dekat Clubhouse dan fasilitas olahraga",
    ...
    },
    {
      ...
      status: "Tersedia",
      fasilitas: "Smart Home, 3 Kamar Tidur, Garden",
      catatan: "Posisi strategis di blok M",
      created_at: "2026-06-01T00:00:00Z",
    },
    {
      id: 5,
      ...
      status: "Tersedia",
      fasilitas: "Smart Home, 3 Kamar Tidur, Garden",
      catatan: "Unit standar cluster Mahogany",
      created_at: "2026-06-01T00:00:00Z",
    },
    {
      id: 11,
      ...
      harga: 950000000,
      status: "Terjual",
      fasilitas: "2 Kamar Tidur, 1 Carport, Taman Depan",
      catatan: "Akses cepat ke pintu keluar cluster",
    ...
    },
    {
      ...
      status: "Terjual",
      fasilitas: "2 Kamar Tidur, 1 Carport, Taman Depan",
      catatan: "Dekat area bermain anak (Playground)",
    ...
    },
    {
      ...
      harga: 950000000,
      status: "Dipesan",
      fasilitas: "2 Kamar Tidur, 1 Carport, Taman Belakang",
      catatan: "Unit dengan sisa tanah lebih luas di belakang",
    ...
    },
    {
      ...
      harga: 780000000,
      status: "Tersedia",
      fasilitas: "2 Kamar Tidur, 1 Carport",
      catatan: "Tipe favorit keluarga muda",
    ...
    },
    {
      ...
      status: "Tersedia",
      fasilitas: "2 Kamar Tidur, 1 Carport",
      catatan: "Unit standar cluster Pine",
      created_at: "2026-06-10T00:00:00Z",
    },
    {
      id: 21,
      ...
      status: "Terjual",
      fasilitas: "2 Kamar Tidur, 1 Carport",
      catatan: "Dekat fasilitas jogging track cluster",
    ...
    },
    {
      ...
      status: "Dipesan",
      fasilitas: "2 Kamar Tidur, 1 Carport",
      catatan: "Fasad minimalis modern",
    ...
    },
    {
      ...
      status: "Tersedia",
      fasilitas: "2 Kamar Tidur, 1 Carport",
      catatan: "Unit siap bangun (Inden)",
      created_at: "2026-06-12T00:00:00Z",
    },
    {
      id: 24,
      ...
      harga: 420000000,
      status: "Tersedia",
      fasilitas: "1 Kamar Tidur, 1 Carport",
      catatan: "Cocok untuk investasi sewa",
      created_at: "2026-06-12T00:00:00Z",
    },
    {
      id: 25,
      ...
      status: "Blokir",
      fasilitas: "1 Kamar Tidur, 1 Carport",
      catatan: "Unit reserved untuk staff marketing",
      created_at: "2026-06-12T00:00:00Z",
    },
  ],
  ...
  leads: [
    {
      ...
      minat: "Mahogany",
      budget: 2000000000,
      marketing: "Andi Setiawan",
      catatan: "Mencari unit hook premium dengan view taman",
    ...
    },
    {
      ...
      nama: "Maya Sari",
      hp: "081399887766",
      email: "mayasari@yahoo.com",
      sumber: "Website",
      status: "Survey",
      minat: "Pine",
      budget: 1000000000,
      marketing: "Dewi Rahma",
      catatan: "Sudah survey lokasi, tertarik tipe 60/120",
    ...
    },
    {
      ...
      nama: "Dedi Kurniawan",
      hp: "085611223344",
      email: "dedikur@outlook.com",
      sumber: "Referral",
      status: "KPR",
      minat: "Oak",
      budget: 600000000,
      marketing: "Fajar Nugroho",
      catatan: "Sedang proses BI Checking di Bank BTN",
    ...
    },
    {
      ...
      minat: "Pine",
      budget: 850000000,
      marketing: "Maya Kusuma",
      catatan: "Tanya simulasi cicilan 15 tahun",
    ...
    },
    {
      ...
      budget: 500000000,
      marketing: "Andi Setiawan",
      catatan: "Ingin cicilan ringan atau DP 0%",
  ...
  customers: [
    {
      ...
      total: 1850000000,
      terbayar: 1850000000,
      metode_bayar: "Cash Keras",
      sumber: "Walk-in",
      marketing: "Andi Setiawan",
      tgl_akad: "2026-01-15T00:00:00Z",
      catatan: "Pelunasan lunas 100%, serah terima kunci sudah dilakukan",
      status: "Lunas",
      created_at: "2026-01-05T00:00:00Z",
    },
    {
      ...
      sumber: "Instagram",
      marketing: "Dewi Rahma",
      tgl_akad: "2026-03-10T00:00:00Z",
      catatan: "DP 20% lunas, dokumen KPR sudah masuk ke Bank Mandiri",
      status: "Aktif",
    ...
    },
    {
      ...
      sumber: "Website",
      marketing: "Fajar Nugroho",
      tgl_akad: "2026-02-05T00:00:00Z",
      catatan: "Tenor 12 bulan, cicilan bulan ke-5 belum masuk",
      status: "Menunggak",
    ...
    },
    {
      ...
      sumber: "Referral",
      marketing: "Maya Kusuma",
      tgl_akad: "2026-05-20T00:00:00Z",
      catatan: "DP lunas, akad KPR dijadwalkan akhir bulan ini",
      status: "Aktif",
    ...
    },
    {
      ...
      sumber: "Pameran",
      marketing: "Andi Setiawan",
      tgl_akad: "2025-12-15T00:00:00Z",
      catatan: "KPR Cair penuh, unit sedang masa garansi",
      status: "Lunas",
  ...
  bookings: [
    {
      id: 301,
      nama_calon: "Dewi Lestari",
      hp: "081255443322",
      nominal_booking: 20000000,
      tgl_booking: "2026-06-10",
      tgl_expired: "2026-06-24",
      unit_id: 3,
      unit_kode: "M-03",
      status: "Aktif",
      catatan: "Mahogany Cluster, rencana KPR via BNI",
    },
    {
      id: 302,
      nama_calon: "Raka Pradana",
      hp: "085711223344",
      nominal_booking: 10000000,
      tgl_booking: "2026-06-12",
      tgl_expired: "2026-06-26",
      unit_id: 13,
      unit_kode: "P-03",
      status: "Aktif",
      catatan: "Pine Cluster, sedang diskusi perubahan layout interior",
    },
    {
      id: 303,
      nama_calon: "Lia Ananta",
      hp: "081299001122",
      nominal_booking: 5000000,
      tgl_booking: "2026-06-13",
      tgl_expired: "2026-06-27",
      unit_id: 22,
      unit_kode: "O-02",
      status: "Aktif",
      catatan: "Oak Cluster, rencana Cash Bertahap 6x",
    },
  ],
  ...
  reminders: [
    {
      id: 401,
      lead_nama: "Bambang Sugiantoro",
      catatan: "Kirim brosur unit hook Mahogany",
      tgl_reminder: "2026-06-15",
      selesai: false,
    },
    {
      id: 402,
      lead_nama: "Maya Sari",
      catatan: "Follow up hasil survey unit Pine",
      tgl_reminder: "2026-06-14",
      selesai: true,
    },
    {
      id: 403,
      lead_nama: "Dedi Kurniawan",
      catatan: "Update status appraisal bank BTN",
      tgl_reminder: "2026-06-16",
      selesai: false,
    },
    {
      id: 404,
      lead_nama: "Rina Wijaya",
      catatan: "Kirim simulasi cicilan KPR 15 thn",
      tgl_reminder: "2026-06-15",
      selesai: false,
    },
  ],
  ...
  approvals: [
    {
      id: 501,
      jenis: "Diskon",
      judul: "Diskon Khusus 50jt - Mahogany M-03",
      deskripsi:
        "Customer Dewi Lestari minta diskon tambahan untuk closing unit Mahogany minggu ini.",
      nominal: 50000000,
      unit_kode: "M-03",
    ...
    {
      id: 502,
      jenis: "Booking Manual",
      judul: "Verifikasi Booking M-01 - Andi Wijaya",
      deskripsi: "Verifikasi transfer dana booking fee via Bank Mandiri.",
      nominal: 20000000,
      unit_kode: "M-01",
    ...
    },
    {
      id: 503,
      jenis: "Pengeluaran",
      judul: "Biaya Event Open House Juni",
      deskripsi: "Pengajuan dana konsumsi dan dekorasi marketing gallery.",
      nominal: 12000000,
      unit_kode: "-",
      customer_nama: "-",
      status: "Pending",
  ...
  keuangan: [
    {
      ...
      keterangan: "Booking M-01 - Andi Wijaya",
      nominal: 20000000,
      dicatat_oleh: "Sales",
      tgl: "2026-01-05",
    },
    {
      ...
      jenis: "masuk",
      kategori: "DP",
      keterangan: "DP 20% M-01 - Andi Wijaya",
      nominal: 350000000,
      dicatat_oleh: "Finance",
      tgl: "2026-01-10",
    },
    {
      id: 603,
      jenis: "masuk",
      kategori: "Penjualan Unit",
      keterangan: "Pelunasan M-01 - Andi Wijaya",
      nominal: 1480000000,
      dicatat_oleh: "Finance",
      tgl: "2026-01-15",
    },
    {
      ...
      keterangan: "Gaji Karyawan Lapangan Mei",
      nominal: 45000000,
      dicatat_oleh: "Finance",
      tgl: "2026-06-01",
    },
    {
      ...
      keterangan: "Social Media Ads (FB/IG) Juni",
      nominal: 10000000,
      dicatat_oleh: "Marketing",
      tgl: "2026-06-02",
    },
    {
      id: 606,
      jenis: "masuk",
      kategori: "Booking Fee",
      keterangan: "Booking O-01 - Budi Santoso",
      nominal: 5000000,
      dicatat_oleh: "Sales",
      tgl: "2026-02-01",
    },
  ...
  payments: [
    {
      ...
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "Booking Fee M-01",
    },
    {
      id: 702,
      customer_id: 201,
      nominal: 350000000,
      tgl_bayar: "2026-01-10",
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "DP Unit M-01",
    },
    {
      id: 703,
      customer_id: 201,
      nominal: 1480000000,
      tgl_bayar: "2026-01-15",
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "Pelunasan Unit M-01",
    },
    {
      id: 704,
      customer_id: 203,
      nominal: 5000000,
      tgl_bayar: "2026-02-01",
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "Booking Fee O-01",
    },
    {
      id: 705,
      customer_id: 203,
      ...
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "DP Unit O-01",
    },
    {
      id: 706,
      customer_id: 203,
      nominal: 35000000,
      tgl_bayar: "2026-03-05",
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "Cicilan 1 Cash Bertahap",
    },
    {
      id: 707,
      customer_id: 203,
      nominal: 35000000,
      tgl_bayar: "2026-04-05",
      metode: "Transfer",
      status: "Diverifikasi",
      keterangan: "Cicilan 2 Cash Bertahap",
    },
  ],
  ...
  tiket: [
    {
      id: 801,
      judul: "AC Kamar Utama Tidak Dingin",
      deskripsi:
        "Unit M-01, AC baru dipasang tapi kurang dingin, mohon cek teknisi.",
      kategori: "Elektronik",
      prioritas: "Sedang",
      customer_id: 201,
      unit_id: 1,
      status: "Diproses",
      tgl_dibuat: "2026-06-10",
    },
    {
      id: 802,
      judul: "Kran Wastafel Bocor",
      deskripsi: "Unit M-01, ada rembesan air di pipa wastafel dapur.",
      kategori: "Plumbing",
      prioritas: "Tinggi",
      customer_id: 201,
      unit_id: 1,
      status: "Selesai",
      tgl_dibuat: "2026-05-15",
    },
    {
      id: 803,
      judul: "Cat Dinding Mengelupas",
      deskripsi: "Unit P-02, cat di area balkon mulai mengelupas.",
      kategori: "Finishing",
      prioritas: "Rendah",
      customer_id: 205,
      unit_id: 12,
      status: "Baru",
      tgl_dibuat: "2026-06-12",
    },
  ],
  ...
  garansi: [
    {
      ...
      customer_id: 201,
      unit_id: 1,
      item_garansi: "Struktur Bangunan",
      tipe_garansi: "10 Tahun",
  ...
  survei: [
    {
      ...
      skor_pelayanan: 5,
      komentar:
        "Kualitas bangunan sangat rapi, layanan sales Bapak Andi sangat membantu.",
    },
    {
      id: 1002,
      customer_id: 205,
      ...
      skor_kualitas: 4,
      skor_pelayanan: 5,
      komentar: "Secara keseluruhan bagus, proses serah terima tepat waktu.",
    },
  ],
  ...
  referral: [
    {
      id: 1101,
      referrer_id: 201,
      nama_referral: "Hendra Pratama",
      hp_referral: "081288776655",
      status: "Selesai",
      catatan: "Closing unit M-02",
    },
    {
      id: 1102,
      referrer_id: 205,
      nama_referral: "Siska Dewi",
      hp_referral: "081122338877",
      status: "Pending",
      catatan: "Tertarik unit Oak",
    },
  ],
  ...
  akuntansi: {
    akun: [
      ...
      {
        id: 3,
        nama: "Persediaan Tanah & Bangunan",
        tipe: "Aset",
        saldo: 12500000000,
      },
    ...
    jurnal: [
      {
        ...
        tgl: "2026-01-15",
        akun: "Kas",
        deskripsi: "Pelunasan Unit M-01 - Andi Wijaya",
        debit: 1480000000,
        kredit: 0,
      },
      {
      ...
      },
      {
        ...
        tgl: "2026-06-01",
        akun: "Beban Gaji",
        deskripsi: "Pembayaran Gaji Staff Mei",
        debit: 45000000,
        kredit: 0,
      },
      {
        ...
        tgl: "2026-06-02",
        akun: "Beban Iklan",
        deskripsi: "Biaya Iklan Digital Juni",
        debit: 10000000,
        kredit: 0,
      },
    ],
    hutang: [
      {
        id: 1301,
        pemasok: "PT Semen Indonesia",
        nominal: 250000000,
        jatuh_tempo: "2026-07-15",
      },
      {
        id: 1302,
        pemasok: "CV Baja Makmur",
        nominal: 180000000,
  ...
  dokumen: [
    ...
    },
    {
      id: 1402,
      customer_id: 201,
      nama: "Perjanjian Pengikatan Jual Beli (PPJB)",
      status: "Ada",
  ...
  bast: [
    ...
    },
    {
      id: 1502,
      customer_id: 205,
      customer_nama: "Rizky Ramadhan",
      unit_id: 12,
      unit_kode: "P-02",
      tgl_serah_terima: "2026-01-10",
      status: "Selesai",
      kondisi: "Baik",
    },
  ],
  ...
  proyek: [
    {
      id: 1601,
      kode: "GSR-01",
      nama: "Grand Surya Residence",
      lokasi: "Cibubur, Jawa Barat",
      tipe: "Residensial & Komersial",
      total_unit: 150,
      luas_lahan: 50000,
      tgl_mulai: "2025-01-01",
      tgl_target: "2027-12-31",
      nilai_proyek: 250000000000,
      deskripsi:
        "Pengembangan hunian terpadu dengan fasilitas lengkap dan akses strategis.",
      status: "Berjalan",
    },
  ],
  ...
  milestones: [
    {
      id: 1801,
      proyek_id: 1601,
      nama: "Pembersihan Lahan (Land Clearing)",
      urutan: 1,
      tgl_target: "2025-03-01",
      persen_bobot: 5,
    ...
    },
    {
      id: 1802,
      proyek_id: 1601,
      nama: "Pembangunan Infrastruktur Jalan",
      urutan: 2,
      tgl_target: "2025-08-01",
      persen_bobot: 15,
      catatan: "Akses utama sudah diaspal",
    },
    {
      id: 1803,
      proyek_id: 1601,
      nama: "Pondasi Cluster Mahogany",
      urutan: 3,
      tgl_target: "2026-01-01",
      persen_bobot: 10,
      catatan: "Selesai, lanjut struktur",
    },
    {
      id: 1804,
      proyek_id: 1601,
      nama: "Pondasi Cluster Pine",
      urutan: 4,
      tgl_target: "2026-04-01",
      persen_bobot: 10,
      catatan: "Dalam pengerjaan 80%",
    },
  ],
  ...
  kontrak: [
    {
      ...
      proyek_id: 1601,
      kontraktor_id: 1701,
      no_kontrak: "CTR/GSR/2025/001",
      pekerjaan: "Infrastruktur & Drainase Utama",
      nilai_kontrak: 45000000000,
      tgl_mulai: "2025-01-10",
      tgl_akhir: "2025-12-31",
      termin_bayar: "Bulanan berdasarkan progress",
    },
    {
      id: 1902,
      proyek_id: 1601,
      kontraktor_id: 1702,
      no_kontrak: "CTR/GSR/2026/005",
      pekerjaan: "Struktur & Arsitektur Cluster Mahogany",
      nilai_kontrak: 75000000000,
      tgl_mulai: "2026-01-15",
      tgl_akhir: "2027-03-31",
      termin_bayar: "Per 20% progress",
    },
  ],
  ...
  promos: [
    {
      id: 2001,
      kode: "DASYAT06",
      nama: "Promo Juni Dahsyat",
      deskripsi: "Diskon DP 50% untuk unit Cluster Pine selama bulan Juni.",
      diskon: "50% DP",
      kuota: 10,
      terpakai: 2,
      tgl_mulai: "2026-06-01",
      tgl_akhir: "2026-06-30",
      status: "Aktif",
    },
    {
      id: 2002,
      kode: "FREEAC",
      nama: "Bonus AC 3 Unit",
      deskripsi: "Bonus 3 unit AC untuk setiap pembelian Mahogany.",
      diskon: "Bonus Barang",
      kuota: 5,
      terpakai: 1,
  ...
  legal: {
    ...
    perizinan: [
      {
        id: 2801,
        nama: "PBG (Persetujuan Bangunan Gedung) Induk",
        status: "Selesai",
        tgl_selesai: "2024-12-20",
      },
      {
        id: 2802,
        nama: "Izin Lingkungan (AMDAL)",
        status: "Selesai",
        tgl_selesai: "2024-11-15",
      },
    ],
    akad: [
      {
    ...
    esign: [
      {
        id: 3001,
        nama_dokumen: "PPJB M-02 - Hendra Pratama",
        status: "Menunggu Ttd",
        tgl_kirim: "2026-06-12",
      },
    ],
    arsip: [
      {
        id: 3101,
        nama_dokumen: "Hardcopy PPJB M-01",
  ...
  cicilan: [
    ...
    },
    {
      ...
      nama: "Siti Aminah",
      unit_kode: "P-01",
      keterangan: "Pelunasan DP 1",
      nominal: 95000000,
      status: "Lunas",
      tgl_jatuh_tempo: "2026-03-15",
      tgl_bayar: "2026-03-12",
      metode: "Transfer Bank",
    },
    {
      id: 3506,
      ...
      nama: "Siti Aminah",
      unit_kode: "P-01",
      keterangan: "Pelunasan DP 2",
      nominal: 95000000,
      status: "Lunas",
      tgl_jatuh_tempo: "2026-04-15",
      tgl_bayar: "2026-04-14",
      metode: "Transfer Bank",
    },
  ],
  ...
  material: [
    ...
    },
    {
      ...
      stok_keluar: 720,
      stok_sisa: 80,
      supplier: "CV Pasir Jaya",
    },
    {
      id: 4005,
      proyek_id: 1601,
      nama: "Cat Tembok Exterior",
      satuan: "Kg",
      harga_satuan: 45000,
      stok_masuk: 600,
      stok_keluar: 600,
  ...
  pekerja: [
    ...
    },
    {
      ...
      proyek_id: 1601,
      nama: "Bayu Pratama",
      jabatan: "Spesialis MEP",
      hp: "081355566677",
      upah_harian: 220000,
      tgl_masuk: "2026-01-10",
      status: "Tidak Aktif",
    },
  ],
  ...
  inspeksi: [
    {
      ...
      unit_kode: "M-01",
      tipe: "Final",
      inspektor: "Ir. Hendrawan Saputra",
      tgl_inspeksi: "2026-01-25",
      status: "Lulus",
      items: [
        { id: 60011, item: "Kualitas Pengecatan", hasil: "OK", catatan: "" },
        {
          id: 60012,
          item: "Instalasi Listrik & Lampu",
          hasil: "OK",
          catatan: "",
        },
    ...
    },
    {
      ...
      tipe: "Finishing",
      inspektor: "Ir. Hendrawan Saputra",
      tgl_inspeksi: "2026-06-08",
      status: "Perlu Perbaikan",
      items: [
        { id: 60021, item: "Kerataan Plafon", hasil: "OK", catatan: "" },
        {
          id: 60022,
          item: "Pengecatan Dinding",
          hasil: "Tidak OK",
          catatan: "Ada retak rambut di ruang tamu, perlu diplamir ulang",
        },
        { id: 60023, item: "Pemasangan Keramik", hasil: "OK", catatan: "" },
        {
          ...
          item: "Kusen & Pintu",
          hasil: "Tidak OK",
          catatan: "Pintu kamar utama belum rapi, perlu penyesuaian",
        },
      ],
    },
    {
      ...
      unit_kode: "P-01",
      tipe: "Struktur",
      inspektor: "Dewi Anggraini, ST",
      tgl_inspeksi: "2026-05-20",
      status: "Lulus",
      items: [
        {
          id: 60031,
          item: "Kualitas Pengecoran Kolom",
          hasil: "OK",
          catatan: "",
        },
...
function getMockResponse(config) {
  ...
  if (method === "get") {
    ...
    if (path === "/reminders/badge") {
      return clone({
        jumlah: mockState.reminders.filter((item) => !item.selesai).length,
      });
    }
    ...
    if (path.startsWith("/proyek/inspeksi/")) {
      ...
      const id = Number(ids?.[0]);
      return clone(mockState.inspeksi.find((item) => item.id === id) || null);
    }
    ...
    if (path === "/cicilan/") {
      ...
      const customersSummary = mockState.customers.map((cust) => {
        ...
        const telat = items.filter((it) => {
          ...
          return due < today && it.status !== "Lunas" ? true : false;
        }).length;
  ...
  if (["post", "put", "patch", "delete"].includes(method)) {
    if (path === "/auth/register-customer") {
      return clone({
        user: { id: 999, nama: body?.nama || "Customer", role: "customer" },
        token: "fake-customer-token",
      });
    }
    if (path === "/survei/kirim") {
      return clone({ success: true, pesan: "Terima kasih atas masukan Anda!" });
    }
